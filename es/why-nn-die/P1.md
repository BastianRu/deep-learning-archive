...
Bueno, para responder a esta pregunta tenemos que analizar el flujo de los datos a traves de la red, y entender las transformaciones que sufren, y como esto afecta en el aprendizaje, que sera nuestro foco de analisis en este articulo. 
...
<figure style="text-align: center; margin: 20px 0;">
  <img src="nn.png" alt="MLP Architecture" style="max-width: 100%; height: auto;">
  <figcaption style="font-size: 0.85em; color: #666; font-style: italic; margin-top: 8px;">
    Figure 1: A simple MLP. Image by author.
  </figcaption>
</figure>
...
<figure style="text-align: center; margin: 20px 0;">
  <img src="grid_tanh-graph.png" alt="Hyperbolic tangent" style="max-width: 100%; height: auto;">
  <figcaption style="font-size: 0.85em; color: #666; font-style: italic; margin-top: 8px;">
    Figure 2: Hyperbolic tangent. Image by author.
  </figcaption>
</figure>
...
Aunque esta expresión no debe interpretarse como una igualdad exacta en términos escalares, sí refleja la estructura fundamental del gradiente: su dependencia crítica de los productos acumulados de los pesos y de las derivadas de las funciones de activación a lo largo de las capas.

Desde una perspectiva matemática, hemos puesto al descubierto la vulnerabilidad central de las arquitecturas profundas. Si estos productos acumulativos se desvían, aunque sea ligeramente, de la unidad, la red está esencialmente condenada a uno de dos destinos: explotar hacia una inestabilidad numérica incontrolable o colapsar en una completa inmovilidad.

#### El Camino hacia el Equilibrio: Un Vistazo a la Preservación de la Varianza

¿Cómo combatir una falla estructural cuya magnitud crece exponencialmente con la profundidad de la red? ¿Es posible modificar estratégicamente el estado inicial de los pesos para neutralizar esta degradación incluso antes de que comience el entrenamiento?

La respuesta no se encuentra en valores deterministas, sino en el elegante dominio de la **probabilidad y la estadística**. Para evitar que el gradiente muera en las primeras capas, el aprendizaje profundo moderno se apoya en un concepto fundamental: la **preservación de la energía y de la varianza**. Debemos diseñar una estrategia de inicialización en la que la varianza de las señales permanezca completamente estable a medida que estas se propagan hacia adelante y hacia atrás a través de la red.

En nuestra próxima publicación, profundizaremos en la derivación matemática y estadística que permitió resolver esta crisis en 2010. Analizaremos cómo las distribuciones normales, las distribuciones uniformes y los célebres factores de escalamiento de varianza formulados por Xavier Glorot y Yoshua Bengio sentaron las bases fundamentales que permiten a las redes neuronales profundas aprender desde cero.
